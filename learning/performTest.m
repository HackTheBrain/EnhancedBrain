...
global stopSimulation
        ...
        while 1
            ...
            if xLength>=buffSize
                ...
                totalTime = time + totalTime;
                        ...
                        if totalTime-time>=timeBeforeExecution 
        ...
        %    beta
            %here we should store data - beta waves, raw EEG, 
            betaDataToStore = rel_beta;
            focusDataToStore = betaAverage(~isnan(betaAverage));
            ...
            focusIndexToStore = length(focusDataToStore);
